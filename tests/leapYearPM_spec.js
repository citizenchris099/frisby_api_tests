...
var scenarioDetails = function (get) {
    var details = new Map();
    var startDate = utility.now(0, "2016-02-28T01:00:00.999Z");
    var dueWithin = {"minutes" : 30};

    var dailyTasksExpected = 3;
    ...
    var dailyCreateExpect = utility.expectArray(dailyTasksExpected, 'd', 0,"2016-02-28T01:00:00.999Z");
    var dailyDueExpect = utility.dueDateArray(dailyCreateExpect, 'h', 1);
    var weeklyCreateExpect = utility.expectArray(weeklyTasksExpected, 'w', 0,"2016-02-28T01:00:00.999Z");
    var weeklyDueExpect = utility.dueDateArray(weeklyCreateExpect, 'd', 1);
    var bwCreateExpect = utility.expectArray(bwTasksExpected, 'bw', 0,"2016-02-28T01:00:00.999Z");
    var bwDueExpect = utility.dueDateArray(bwCreateExpect, 'd', 1);
    var monthlyCreateExpect = utility.expectArray(monthlyTasksExpected, 'M', 0,"2016-02-28T01:00:00.999Z");
    var monthlyDueExpect = utility.dueDateArray(monthlyCreateExpect, 'w', 1);
    var quarterlyCreateExpect = utility.expectArray(quarterlyTasksExpectded, 'Q', 0,"2016-02-28T01:00:00.999Z");
    var quarterlyDueExpect = utility.dueDateArray(quarterlyCreateExpect, 'w', 2);
    var saCreateExpect = utility.expectArray(saTasksExpected, 'sa', 0,"2016-02-28T01:00:00.999Z");
    var saDueExpect = utility.dueDateArray(saCreateExpect, 'M', 1);
    var annuallyCreateExpect = utility.expectArray(annuallyTasksExpected, 'y', 0,"2016-02-28T01:00:00.999Z");
...
describe('pm leap year scenario', function () {
    it('can run the leap year scenario', function () {
        utility.scenario('pm', getArray, scenarioDetails, pmToPost, pmExpect, taskJson, utility.now(0,"2016-03-01T01:00:00.999Z"));
    });
});