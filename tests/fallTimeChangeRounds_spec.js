/**
 * Created by kenziegossett on 5/22/17.
 */
...
var timeChangeScenarioDetails = function (get) {
    var details = new Map();
    var hourlyStartDate = utility.now(0, "2018-11-05T00:00:00.000Z");
    var dailyStartDate = utility.now(0, "2018-11-04T00:00:00.000Z");
    var startDate = utility.now(0, "2018-11-01T00:00:00.000Z");
    ...
    var hourlyCreateExpect = utility.expectArray(hourlyTasksExpected, 'h', 0,"2018-11-05T00:00:00.000Z");
    var hourlyDueExpect = utility.dueDateArray(hourlyCreateExpect, 'h');
    var dailyCreateExpect = utility.expectArray(dailyTasksExpected, 'd', 0,"2018-11-04T00:00:00.000Z");
    var dailyDueExpect = utility.dueDateArray(dailyCreateExpect, 'h');
    var weeklyCreateExpect = utility.expectArray(weeklyTasksExpected, 'w', 0,"2018-11-01T00:00:00.000Z");
    var weeklyDueExpect = utility.dueDateArray(weeklyCreateExpect, 'h');
    var bwCreateExpect = utility.expectArray(bwTasksExpected, 'bw', 0,"2018-11-01T00:00:00.000Z");
    var bwDueExpect = utility.dueDateArray(bwCreateExpect, 'h');
    var monthlyCreateExpect = utility.expectArray(monthlyTasksExpected, 'M', 0,"2018-11-01T00:00:00.000Z");
    var monthlyDueExpect = utility.dueDateArray(monthlyCreateExpect, 'h');
    var quarterlyCreateExpect = utility.expectArray(quarterlyTasksExpected, 'Q', 0,"2018-11-01T00:00:00.000Z");
    var quarterlyDueExpect = utility.dueDateArray(quarterlyCreateExpect, 'h');
    var saCreateExpect = utility.expectArray(saTasksExpected, 'sa', 0,"2018-11-01T00:00:00.000Z");
    var saDueExpect = utility.dueDateArray(saCreateExpect, 'h');
    var annuallyCreateExpect = utility.expectArray(annuallyTasksExpected, 'y', 0,"2018-11-01T00:00:00.000Z");
    var annuallyDueExpect = utility.dueDateArray(annuallyCreateExpect, 'h');
...
var idArray;
describe('round fall time change scenario', function () {
    it('can run the fall time change scenario', function () {
        utility.scenario('rounds', getArray, timeChangeScenarioDetails, roundToPost, roundExpect, taskJson, utility.now(0,"2018-11-06T00:00:00.000Z"))
    });
});