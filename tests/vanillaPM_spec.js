...
var scenarioDetails = function (get) {
	var details = new Map();
	var startDate = utility.now(0, "2017-05-17T00:00:00.000Z");
	...
	var dailyCreateExpect = utility.expectArray(dailyTasksExpected, 'd', 0,"2017-05-17T00:00:00.000Z");;
	var dailyDueExpect = utility.dueDateArray(dailyCreateExpect, 'h', 1);
	var weeklyCreateExpect = utility.expectArray(weeklyTasksExpected, 'w', 0,"2017-05-17T00:00:00.000Z");
	var weeklyDueExpect = utility.dueDateArray(weeklyCreateExpect, 'd', 1);
	var bwCreateExpect = utility.expectArray(bwTasksExpected, 'bw', 0,"2017-05-17T00:00:00.000Z");
	var bwDueExpect = utility.dueDateArray(bwCreateExpect, 'd', 1);
	var monthlyCreateExpect = utility.expectArray(monthlyTasksExpected, 'M', 0,"2017-05-17T00:00:00.000Z");
	var monthlyDueExpect = utility.dueDateArray(monthlyCreateExpect, 'w', 1);
	var quarterlyCreateExpect = utility.expectArray(quarterlyTasksExpectded, 'Q', 0,"2017-05-17T00:00:00.000Z");
	var quarterlyDueExpect = utility.dueDateArray(quarterlyCreateExpect, 'w', 2);
	var saCreateExpect = utility.expectArray(saTasksExpected, 'sa', 0,"2017-05-17T00:00:00.000Z");
	var saDueExpect = utility.dueDateArray(saCreateExpect, 'M', 1);
	var annuallyCreateExpect = utility.expectArray(annuallyTasksExpected, 'y', 0,"2017-05-17T00:00:00.000Z");
...
describe('pm vanilla scenario', function () {
	it('can run the vanilla scenario', function () {
		utility.scenario('pm', getArray, scenarioDetails, pmToPost, pmExpect, taskJson, utility.now(0,"2017-05-18T00:00:00.000Z"))
	});
});